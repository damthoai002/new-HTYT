...
{
    public partial class frmSearchNhanVien : Form
    {


        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(frmSearchNhanVien));
        ...
        private void btnChon_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(clsResources.GetMessage("messages.frmSearchNhanVien.SelectNhanVien"), clsResources.GetMessage("messages.frmSearchNhanVien.ErrorTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else {
