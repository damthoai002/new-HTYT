...
{
    public partial class FrmCreateLeaveAccident : Form
    {
        #region Private fields

        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(FrmCreateLeaveAccident));
        ...
        {
            DataTable tb = _ngayNghiHopLeBo.GetNgaynghiTaiNan(maTruongNhom, tenNhanVien);
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ValidatedDate())
                {
                    ...
                    _ngayNghiHopLeBo.TaoNgayNghiTaiNan(maTruongNhom, maGiaoDich, tuNgay, denNgay, lydo1, lydo1ChiTiet,
                    ...
                    MessageBox.Show(clsResources.GetMessage("messages.FrmCreateLeaveAccident.save.success"),
            ...
            {
                MessageBox.Show(clsResources.GetMessage("messages.FrmCreateLeaveAccident.save.UnSuccess"),
                        clsResources.GetMessage("messages.general"), MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void SendMailForTruongNhomAndNhanVien(bool isCapNhatChamCong, string tenNhanVien, string tentruongNhom, string maNhanVien, string maTruongNhom, string tuNgay, string denNgay)
        {
            ...
            if (isCapNhatChamCong)
            {
                ...
                SendEmail(emailTruongNhom,emailNhanVien,clsResources.GetMessage("messages.FrmCreateLeaveAccident.EmailSubject"), body);
        ...
        private bool ValidatedDate()
        {
            ...
            {
                erp.SetError(dtpToDay, clsResources.GetMessage("messages.FrmCreateLeaveAccident.DateValid", dtpFromDay.Text, dtpToDay.Text));
                dtpToDay.Focus();
                return false;
            }
            ...
            {
                erp.SetError(dtpFromDay, clsResources.GetMessage("messages.FrmCreateLeaveAccident.DateExists", dtpFromDay.Text, dtpToDay.Text));
                dtpFromDay.Focus();
                return false;
            }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                grdNghiPhep.DataSource = _ngayNghiHopLeBo.GetNgaynghiTaiNan(clsSystemConfig.UserName, txtTenNhanVien.Text);
            }
        }
