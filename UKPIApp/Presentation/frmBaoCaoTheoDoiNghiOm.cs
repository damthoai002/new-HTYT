...
{
    public partial class frmBaoCaoTheoDoiNghiOm : Form
    {
        ...
        public frmBaoCaoTheoDoiNghiOm()
        {

            InitializeComponent();

          //  clsTitleManager.InitTitle(this);
            this.Text = "Báo Cáo Theo Dõi Nghĩ Ốm";
            SetDefauldValue();
        ...
        private void frmBaoCaoTheoDoiNghiOm_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoTheoDoiNghiOm.rdlc";
            ...
            _tbToaThuoc = _reportBo.baoCaoTheoDoiNghiOm(kho, quy, nam, tuNgay, denNgay);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsBaoCaoTheoDoiNghiOm";
