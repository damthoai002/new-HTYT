...
{
    public partial class frmBaoCaoTongTienBHYT : Form
    {
        ...
        public frmBaoCaoTongTienBHYT()
        {

            InitializeComponent();

          //  clsTitleManager.InitTitle(this);
            this.Text = "Báo Cáo Thành Tiền Sử Dụng";
            SetDefauldValue();
        ...
        private void SetDefauldValue()
        {
            ...
            txtQuy.Text = DateTime.Now.Month.ToString();
        ...
        private void frmBaoCaoTongTienBHYT_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoTongTienSuDungBHYT.rdlc";

            DataTable _tbToaThuoc = new DataTable();

            var quy = ckbBaoCaoTheoQuyNam.Checked ? txtQuy.Text : "";
            var nam = ckbBaoCaoTheoQuyNam.Checked ? txtNam.Text : "";
            ...
            _tbToaThuoc = _reportBo.baoCaoTongTienBHYT(kho, quy, nam, tuNgay, denNgay);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsBaoCaoTongTienBHYT";
