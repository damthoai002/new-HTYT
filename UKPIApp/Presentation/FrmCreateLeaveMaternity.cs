...
{
    public partial class FrmCreateLeaveMaternity : Form
    {
        #region Private fields

        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(FrmCreateLeaveMaternity));
        ...
        public FrmCreateLeaveMaternity()
        {
        ...
        {
            DataTable tb = _ngayNghiHopLeBo.GetNgaynghiThaiSan(maTruongNhom, tenNhanVien,"");
        ...
        private void BindNhanVien()
        {
            ...
            cboNhanVien.DataSource = _ngayNghiHopLeBo.GetNhanVienNghiThaiSan(clsSystemConfig.UserName);
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ValidatedDate())
                {
                    string maTruongNhom = clsSystemConfig.MaNhanVien.ToString();
                    ...
                    _ngayNghiHopLeBo.TaoNgayNghiThaiSan(maTruongNhom, maGiaoDich, tuNgay, denNgay, lydo1, lydo1ChiTiet,
                    ...
                    MessageBox.Show(clsResources.GetMessage("messages.FrmCreateLeaveMaternity.save.success"),
            ...
            {
                MessageBox.Show(clsResources.GetMessage("messages.FrmCreateLeaveMaternity.save.UnSuccess"),
                        clsResources.GetMessage("messages.general"), MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void SendMailForTruongNhomAndNhanVien(bool isCapNhatChamCong, string tenNhanVien, string tentruongNhom, string maNhanVien, string maTruongNhom, string tuNgay, string denNgay)
        {
            ...
            if (isCapNhatChamCong)
            {
                ...
                SendEmail(emailTruongNhom,emailNhanVien,clsResources.GetMessage("messages.FrmCreateLeaveMaternity.EmailSubject"), body);
        ...
        private bool ValidatedDate()
        {
            ...
            {
                erp.SetError(dtpToDay, clsResources.GetMessage("messages.FrmCreateLeaveMaternity.DateValid", dtpFromDay.Text, dtpToDay.Text));
                dtpToDay.Focus();
                return false;
            }
            ...
            {
                erp.SetError(dtpFromDay, clsResources.GetMessage("messages.FrmCreateLeaveMaternity.DateExists", dtpFromDay.Text, dtpToDay.Text));
                dtpFromDay.Focus();
                return false;
            }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                grdNghiPhep.DataSource = _ngayNghiHopLeBo.GetNgaynghiThaiSan(clsSystemConfig.UserName, txtTenNhanVien.Text, dtpNgayNghi.Value.ToString(clsCommon.ApproveTimesheet.DateFormatDb));
            }
        }
        ...
        private bool ValidatedTenNhanVien()
        {
           erp.Clear();
            ...
            if (!_common.IsLetterAndDigitExceptWc(tenNv))
            {
                erp.SetError(txtTenNhanVien, clsResources.GetMessage("errors.string", txtTenNhanVien.Text));
