...
{
    public partial class FrmApproveTimesheetL4 : Form
    {
        #region Private fields

        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(FrmApproveTimesheetL4));
        ...
        public List<ClsLichLamViec> GetDataToApproveSave()
        {
            ...
            lstLichLamViec.AddRange(from DataRow row in table.Rows
                                    ...
                                    select new ClsLichLamViec
                                    {
                                        SysId = long.Parse(row[ChamCongLichLamViecDAO.SysID].ToString()),
                                        L4XacNhan = true,
                                        L4XacNhan_Date = DateTime.Now.ToString(clsCommon.ApproveTimesheet.DateFormatDb),
                                        L4XacNhan_Id = clsSystemConfig.MaNhanVien.ToString(),
                                        L4XacNhan_TenNgan = clsSystemConfig.FullName,
                                        LastUpDate = DateTime.Now.ToString(clsCommon.ApproveTimesheet.DateFormatDb),
        ...
        private bool OnApprove()
        {
            try
            {
                ...
                lichLamViec.XacNhanChamCongLichLamViecL4(lstChamCong);
