...
{
    public partial class frmBaoCaoDanhMucThuocTTBH : Form
    {
        ...
        public frmBaoCaoDanhMucThuocTTBH()
        {
        ...
        private void frmBaoCaoDanhMucThuocTTBH_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoThuocTDTTBHYT.rdlc";
            ...
            _tbToaThuoc = _reportBo.baoCaoThuocTanDuocTTBHYT(  kho,  quy,  nam,  tuNgay,  denNgay);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsBaoCaoTdTTBHYT";
