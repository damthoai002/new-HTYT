...
{
    public partial class frmBaoCaoBenhNhanNamNu : Form
    {
        ...
        private void frmBaoCaoBenhNhanNamNu_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "baoCaoBenhNhanNamNu.rdlc";
            ...
            _tbToaThuoc = _reportBo.baoCaoBenhNhanNamNu(kho, quy, nam, tuNgay, denNgay);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsbaoCaoBenhNhanNamNu";
