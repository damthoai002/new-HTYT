...
{
    public partial class frmBaoCaoLichSuKhamChuaBenhVaPhatThuoc : Form
    {
        #region Private fields

        private static readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(frmBaoCaoLichSuKhamChuaBenhVaPhatThuoc));
        ...
        public frmBaoCaoLichSuKhamChuaBenhVaPhatThuoc()
        {
            InitializeComponent();
            SetDefauldValue();        
        }
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoLichSuKhamBenhVaPhatThuoc.rdlc";
            ...
            _tbToaThuoc = _reportBo.baoCaoLichSuKhamBenhVaPhatThuoc(maBenhNhan, tenBenhNhan, maBHYT, tuNgay, denNgay, khuVuc, boPhan, nhomBenh, maBenh, tenBenh);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsBaoCaoLichSuKhamBenhVaPhatThuoc";
        ...
        private void frmBaoCaoLichSuKhamChuaBenhVaPhatThuoc_Load(object sender, EventArgs e)
        {
