...
{
    public partial class frmBaoCaoKhamBenhBHYT_Thang : Form
    {
        ...
        public frmBaoCaoKhamBenhBHYT_Thang()
        {

            InitializeComponent();

            // clsTitleManager.InitTitle(this);
            this.Text = "Báo báo khám bệnh BHYT tháng";
            SetDefauldValue();
        ...
        private void frmBaoCaoKhamBenhBHYT_Thang_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoKhamBenhBHYT_Thang.rdlc";

            DataTable _tbToaThuoc = new DataTable();

            var thang = ckbBaoCaoTheoQuyNam.Checked ? cboThang.Text : "";
            ...
            _tbToaThuoc = _reportBo.baoCaoKhamBenhBHYT_Thang(kho, thang, nam);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsBaoCaoKhamBenhBHYT_Thang";
