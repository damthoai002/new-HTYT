...
{
    public partial class frmBaoCaoBNBHYTTTBH : Form
    {
        ...
        private void frmBaoCaoBNBHYTTTBH_Load(object sender, EventArgs e)
        {
        ...
        private void RunReport()
        {
            ...
            localReport.ReportPath = dir + "BaoCaoNguoiBenhBHYTDNTT1.rdlc";
            ...
            _tbToaThuoc = _reportBo.baoCaoBenhNhanNgoaiTruTTBHYT(kho, quy, nam, tuNgay, denNgay);

            // Create a report data source for the sales order data
            ReportDataSource dsToaThuoc = new ReportDataSource();
            dsToaThuoc.Name = "dsNguoiBenhBHYTDNTT";
