...
{
    class DataGridView_RowNum: DataGridView
    {
        public DataGridView_RowNum()
        {
        ...
        //    ////if necessary
        //    //if (this.RowHeadersWidth < (int)(size.Width + 10)) this.RowHeadersWidth = (int)(size.Width + 10);
        ...
        //    //e.Graphics.DrawString(strRowNumber, this.Font, b, e.RowBounds.Location.X + 8, e.RowBounds.Location.Y + ((e.RowBounds.Height - size.Height) / 2));
